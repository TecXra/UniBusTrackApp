...
public class BusDetail extends FragmentActivity implements AsyncResponse {
    ...
    private void BusLocation()
    {
        ...
        RequestExecutor re = new RequestExecutor(BusDetail.this);
        re.delegate = BusDetail.this;
        re.execute("2",Id);
...
//            Log.d("Exception while downloading url", e.toString());
    ...
    public void onProcessCompelete(Object result) {
       ...
       LatLng stop = (LatLng)result;
        ...
        Marker lahore = map.addMarker(new MarkerOptions().position(stop)
                .title("Lahore").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA)));
